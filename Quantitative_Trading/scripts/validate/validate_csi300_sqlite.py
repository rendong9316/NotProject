...
def main() -> None:
    ...
    parser.add_argument("database", type=Path, nargs="?", default=ROOT / "data" / "csi300_2010_present.sqlite")
    parser.add_argument("--report", type=Path, default=ROOT / "data" / "database_quality_report.json")
