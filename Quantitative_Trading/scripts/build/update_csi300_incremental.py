...
try:
    ...
    from scripts.build.apply_official_membership import (
        apply_update as apply_official_update,
        load_adjustments,
        load_raw_snapshots,
        match_official_snapshots,
    )
    from scripts.build.build_corporate_actions import (
        ensure_schema as ensure_corporate_schema,
        fetch_actions,
        normalize_actions,
        rebuild_factor_events,
...
def main() -> None:
    ...
    parser.add_argument("--archive-root", type=Path, default=ROOT / "data" / "increments")
