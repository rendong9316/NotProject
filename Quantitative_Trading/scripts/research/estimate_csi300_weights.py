...
Usage:
    python estimate_csi300_weights.py --start-date 2020-01-02 --end-date 2026-07-31 --output data/csi300_weights.csv
"""
...
def estimate_weights(
    ...
    comps = pd.read_csv(ROOT / "data" / "components.csv")
...
def main():
    ...
    parser.add_argument("--db", type=Path, default=ROOT / "data" / "csi300_2010_present.sqlite")
    parser.add_argument("--output", type=Path, default=ROOT / "data" / "csi300_weights.csv")
