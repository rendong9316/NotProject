"""补抓 2018-12-03 调整公告(id=12807) 正文+附件"""
...
with sync_playwright() as p:
    ...
    print(f'标题: {title}\n日期: {date}\n正文长度: {len(body)}')
    print('开头:', body[:200].replace('\n', ' '))
    with open('scratch/raw_news/12807.json', 'w', encoding='utf-8') as f:
        json.dump({'id': '12807', 'expected_date': '2018-12-03', 'actual_date': date,
