...
def main() -> None:
    ...
    parser.add_argument("--output-csv", type=Path, default=Path("data_v5/membership_snapshots_official_regular.csv"))
    parser.add_argument("--report", type=Path, default=Path("data_v5/official_membership_update_report.json"))
    parser.add_argument("--backup-dir", type=Path, default=Path("data_v5/backups"))
    parser.add_argument("--manifest", type=Path, default=Path("data_v5/database_manifest.json"))
